...
메신저 첨부는 `NOW_MESSENGER_MAX_UPLOAD_MB`, `NOW_MESSENGER_ALLOWED_EXTENSIONS`, `NOW_MESSENGER_ALLOWED_MIME_TYPES` 기준으로 크기, 확장자, MIME을 함께 제한합니다.
