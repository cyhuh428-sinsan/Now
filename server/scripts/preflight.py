    ...
    if smoke_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("운영 점검 화면에 기기별 연결 토큰 항목", "Smoke checks ops ready token guidance", "ops ready token"),
                ("운영 점검 화면에 사용자 로그인 준비 항목", "Smoke checks ops page public login guidance", "ops page public login"),
