    ...
    if release_readiness_check_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("Custom Locations", "Release readiness script documents NPM path routing", "release readiness script NPM path routing"),
                ("/openapi.json", "Release readiness script documents OpenAPI path routing", "release readiness script OpenAPI path routing"),
    ...
    if release_readiness_service_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("Custom Locations", "Release readiness service documents NPM path routing", "NPM path routing guidance"),
    ...
    if monitor_api_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("Custom locations", "Monitor release page shows NPM path routing option", "release NPM path routing"),
    ...
    if deploy_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("Custom locations", "Deploy checklist documents NPM path routing", "NPM custom locations"),
                ("/openapi.json", "Deploy checklist documents OpenAPI path routing", "OpenAPI custom location"),
    ...
    if public_server_path.exists():
        ...
        check_text_contains(
            ...
            [
                ...
                ("방식 A. 도메인 전체를 NowNote API로 연결", "Public server guide documents full-domain proxy mode", "NPM full-domain mode"),
                ("방식 B. 기존 개인정보처리방침 사이트를 유지하고 API 경로만 연결", "Public server guide documents path proxy mode", "NPM path mode"),
