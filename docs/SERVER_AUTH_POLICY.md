...
- 앱과 Web/설치형 프로그램은 서버 주소, API 토큰, 사용자별 접속 토큰, 사용자 ID, 기기 ID를 저장해 서버에 연결합니다.
- 2단계 인증 사용자는 연결 테스트 또는 토큰 확인 때 6자리 인증 코드를 함께 입력합니다. 2단계 코드는 저장 대상이 아니라 확인 요청에만 사용합니다.
