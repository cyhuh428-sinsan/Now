...
- 서버 정적/문서/운영 표면 점검은 `server/scripts/preflight.py --env-file .env.example --allow-example` 기준 857/857 통과 상태입니다.
...
- 운영 화면: `/monitor`, `/admin`, 메모/녹음/사용자/기기/동기화/분석/백업/복구/배포/공용 서버/1차 릴리스/Play 등록/공개 저장소 준비 상태 확인.
