...
`docs/PHASE1_RELEASE_CHECKLIST.md` 기준 현재 상태는 57개 중 17개 완료, 40개 남음입니다.
...
- Web/설치형 화면: 계층형 지식 메모, 일자별 메모 팝업 흐름, Markdown 작성/보기, 가져오기/내보내기, 검색, 본문 찾기, 탭 편집, 설정, 도움말.
...
- 공개 저장소 준비: README, 보안 정책, 기여 안내, 이슈/PR 템플릿, GitHub Actions preflight, 민감정보 제외 기준.
...
- Codex 내장 브라우저에서는 파일 다운로드 이벤트와 파일 선택 확인이 제한되어 Markdown/JSON 실제 가져오기·내보내기 완료 처리는 보류.
