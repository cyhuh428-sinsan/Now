...
- Web hosted 모드의 기본 공유 문서 보기를 `그룹 지식체계`로 변경했다.
- 서버 공유 문서 재로딩 시에도 `그룹 지식체계` 탭을 기본 선택하도록 했다.
...
- 설치형 프로그램 트리 목록에만 공유/비공유/읽기 전용 상태 아이콘을 표시하도록 했다.
...
- 생성 파일: `desktop/dist/NowNote-Setup-2.3.5-x64.exe`
- 생성 시각: 2026-06-14 04:41:14
- 파일 크기: 101,032,764 bytes
