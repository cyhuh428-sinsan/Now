...
To connect to a public server, install the app and enter the server URL and connection values provided by the operator in the server connection settings.
...
Use only the connection values separately provided by the operator.
