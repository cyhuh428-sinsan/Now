...
def main() -> None:
    ...
    app_requirements = [
        ...
        ("openNoteFind();", "Ctrl+F opens in-note search directly"),
        ("openSearchPopover();", "Ctrl+Shift+F opens global search directly"),
        ...
        ("/api/v1/group-messages/read", "group messenger read API path"),
    ...
    desktop_main_requirements = [
        ...
        ('label: "본문 찾기",\n          accelerator: "Ctrl+F"', "desktop Ctrl+F note find shortcut"),
        ('label: "검색",\n          accelerator: "Ctrl+Shift+F"', "desktop Ctrl+Shift+F app search shortcut"),
