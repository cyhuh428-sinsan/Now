      ...
      body: ListView(
        ...
        children: const [
          ...
          _HelpSection(
            ...
            points: [
              '서버 주소, API 토큰, 사용자 ID, 기기 ID가 필요합니다.',
              '공용 서버가 요구하면 사용자별 접속 토큰과 2단계 인증 코드도 입력합니다.',
              ...
              '공용 서버 운영 전에는 사용자 직접 가입, 앱/설치형 연결 토큰 발급, 공개 HTTPS, reverse proxy 환경을 확인해야 합니다.',
            ],
          ),
          SizedBox(height: 14),
          _HelpSection(
          ...
          _HelpSection(
            ...
            title: '암호화 저장',
            description: '지식 메모는 필요할 때 메모 단위로 암호화할 수 있습니다.',
            points: [
              '같은 메모를 Web, 설치형 프로그램, 앱에서 열려면 같은 키를 입력해야 합니다.',
